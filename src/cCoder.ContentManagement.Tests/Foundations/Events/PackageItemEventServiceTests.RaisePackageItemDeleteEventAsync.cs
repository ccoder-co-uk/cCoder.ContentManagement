...
public partial class PackageItemEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaisePackageItemDeleteEventAsync()
    {
        ...
        packageItemEventBrokerMock
            .Setup(x => x.RaisePackageItemDeleteEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.PackageItem>>()))
        ...
        packageItemEventBrokerMock.Verify(
            x => x.RaisePackageItemDeleteEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.PackageItem>>()),
            Times.Once
        );
