...
public partial class CultureEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseCultureDeleteEventAsync()
    {
        ...
        cultureEventBrokerMock
            .Setup(x => x.RaiseCultureDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.Culture>>()))
            .Callback<EventMessage<CmsDataModels.Culture>>(message => actualMessage = message)
            .Returns(ValueTask.CompletedTask);

        // When
        await service.RaiseCultureDeleteEventAsync(entity);
        ...
        cultureEventBrokerMock.Verify(
            x => x.RaiseCultureDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.Culture>>()),
            Times.Once
        );
