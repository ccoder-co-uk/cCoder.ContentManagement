...
public partial class PackageEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaisePackageDeleteEventAsync()
    {
        ...
        packageEventBrokerMock
            .Setup(x => x.RaisePackageDeleteEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.Package>>()))
        ...
        packageEventBrokerMock.Verify(
            x => x.RaisePackageDeleteEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.Package>>()),
            Times.Once
        );
