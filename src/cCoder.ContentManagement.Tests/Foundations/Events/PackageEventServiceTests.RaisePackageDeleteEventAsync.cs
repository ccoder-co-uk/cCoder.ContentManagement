...
{
    [Fact]
    public async Task ShouldMapAndCallBrokerWhenRaisePackageDeleteEventAsync()
    {
        // Given
        Package entity = new();
        ...
        packageEventBrokerMock
            .Setup(expression: x => x.RaisePackageDeleteEventAsync(message: It.IsAny<EventMessage<cCoder.Data.Models.Packaging.Package>>()))
