...
public partial class ResourceEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseResourceUpdateEventAsync()
    {
        ...
        resourceEventBrokerMock
            .Setup(expression: x => x.RaiseResourceUpdateEventAsync(message: It.IsAny<EventMessage<CmsDataModels.Resource>>()))
...
expression: x => x.RaiseResourceUpdateEventAsync(message: It.IsAny<EventMessage<CmsDataModels.Resource>>()),
times: Times.Once
        );
