...
public partial class ComponentEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseComponentAddEventAsync()
    {
        ...
        componentEventBrokerMock
            .Setup(x => x.RaiseComponentAddEventAsync(It.IsAny<EventMessage<CmsDataModels.Component>>()))
        ...
        componentEventBrokerMock.Verify(
            x => x.RaiseComponentAddEventAsync(It.IsAny<EventMessage<CmsDataModels.Component>>()),
            Times.Once
        );
