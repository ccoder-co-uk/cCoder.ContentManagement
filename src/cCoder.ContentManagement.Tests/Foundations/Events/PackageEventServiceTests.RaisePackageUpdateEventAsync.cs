...
public partial class PackageEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaisePackageUpdateEventAsync()
    {
        ...
        packageEventBrokerMock
            .Setup(x => x.RaisePackageUpdateEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.Package>>()))
        ...
        packageEventBrokerMock.Verify(
            x => x.RaisePackageUpdateEventAsync(It.IsAny<EventMessage<cCoder.Data.Models.Packaging.Package>>()),
            Times.Once
        );
