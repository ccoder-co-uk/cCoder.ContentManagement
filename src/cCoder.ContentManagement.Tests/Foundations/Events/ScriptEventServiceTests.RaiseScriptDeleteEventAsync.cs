...
{
    [Fact]
    public async Task ShouldMapAndCallBrokerWhenRaiseScriptDeleteEventAsync()
    {
        // Given
        Script entity = new();
        ...
        scriptEventBrokerMock
            .Setup(x => x.RaiseScriptDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.Script>>()))
        ...
        scriptEventBrokerMock.Verify(
            x => x.RaiseScriptDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.Script>>()),
            Times.Once
        );
