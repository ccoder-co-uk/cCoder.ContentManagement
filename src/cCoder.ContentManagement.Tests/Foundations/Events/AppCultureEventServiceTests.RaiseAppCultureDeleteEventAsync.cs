...
public partial class AppCultureEventServiceTests
{
    ...
    public async Task ShouldMapAndCallBrokerWhenRaiseAppCultureDeleteEventAsync()
    {
        ...
        appCultureEventBrokerMock
            .Setup(x => x.RaiseAppCultureDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.AppCulture>>()))
        ...
        appCultureEventBrokerMock.Verify(
            x => x.RaiseAppCultureDeleteEventAsync(It.IsAny<EventMessage<CmsDataModels.AppCulture>>()),
            Times.Once
        );
