...
public class ScriptController : ODataController
{
    ...
    public IActionResult GetMetadata() =>
        Ok((base.Request.Query["extend"] == "true") ? new ContentManagementModelBuilder().Build().EDMModel.GetExtendedMetadataForType("Core", typeof(Script)) : new MetadataContainer(typeof(Script), isEntity: true, hasEndpoint: true));
