...
public class ResourceController : ODataController
{
    ...
    public IActionResult GetMetadata() =>
        Ok((base.Request.Query["extend"] == "true") ? new ContentManagementModelBuilder().Build().EDMModel.GetExtendedMetadataForType("Core", typeof(Resource)) : new MetadataContainer(typeof(Resource), isEntity: true, hasEndpoint: true));
